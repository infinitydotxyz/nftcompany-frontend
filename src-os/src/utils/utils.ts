...
export const orderFromJSON = (order: any): Order => {
  ...
  const fromJSON: Order = {
    ...
    basePrice: new BigNumber(order.basePrice || 0),
    ...
    createdTime: new BigNumber(Math.round(createdDate.getTime() / 1000) || 0),
    listingTime: new BigNumber(order.listingTime || 0),
    expirationTime: new BigNumber(order.expirationTime || 0),
