...
export declare const OPENSEA_FEE_RECIPIENT = "0xAAdd54c429a6eEBD4514135EaD53d98D0Cc57d57";
...
export declare const API_BASE_MAINNET = "https://server.nftcompany.com";
export declare const API_BASE_RINKEBY = "https://testnets-api.opensea.io";
export declare const SITE_HOST_MAINNET = "https://nftcompany.com";
