...
import { API_BASE, RINKEBY_API_BASE, RINKEBY_SITE_HOST, SITE_HOST, PROVIDER_URL_ETH_MAINNET, NFTC_FEE_RECIPIENT } from '../src/utils/constants'; // constants from Infinity
